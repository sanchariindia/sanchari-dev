...
<form role="form" method="post" name="form" action="action/addslideSubmit.php" enctype="multipart/form-data">
...
<input type="text"  name="desc" <?php if(isset($_REQUEST['id']) && $_REQUEST["id"]!=''){?> value="<?php echo $row["desc"];?>" <?php } ?> id="icon" class='form-control'>
</div>
...
<td>
<a href="addslide.php?id=<?php echo $r['id'];?>" onClick="return confirm('Are you want to update ?');" class="btn btn-info" ><i class="fa fa-fw fa-edit"></i></a>
