	...
	$.ajax({url:"changeStatusAjax.php?id="+itemId+"&s="+status, success: function(result){
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">View Project <a class="btn btn-primary" href="addproduct.php"><i class="fa fa-plus"></i> Add Menu Service</a></h3>
            </div>
            <div class="box-body">
...
?>
    ...
    <td>
    <a href="addproduct.php?id=<?php echo $r['id'];?>" onClick="return confirm('Are you want to update ?');" class="btn btn-info" ><i class="fa fa-fw fa-edit"></i></a>
