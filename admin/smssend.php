...
{ 
	...
	<div class="row">
                ...
                <form id="frm" name="frm" action="action/sendsms_file.php" method="post" />
                

<div class="control-group" id="">
    <div class="form-group">
    <label class="col-sm-3 control-label">Enter Mobile Number</label>
    </div>
    <div class="col-sm-9">
	<textarea type="text" id="sms_number" name="sms_numbers" class="form-control" placeholder="Enter Mobile Number Name"></textarea> 
    </div>
    </div>
    <p>&nbsp;</p>
    <div class="control-group" id="">
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    $('.addMoreButtons').on('click', function() {
      $(".appendThisDiv").append('<div class="form-group"><label class="col-sm-4 control-label">Enter Mobile Number</label></div><div class="col-sm-4"><input type="text" id="sms_number" name="sms_number[]" class="form-control" placeholder="Enter Mobile Number Name"  value=""/></div><div class="col-sm-2"><button class="btn btn-primary addMoreButtons"  type="button"> <i class="fa fa-plus"></i> </button></div><div class="col-sm-2"><button onclick="$(this).parent().parent().remove();" type="button" class="deleteItemClass btn btn-danger"> X </button></div>');
    });
