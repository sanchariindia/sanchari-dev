...

{
     ...
     */
       ...
       public function __construct($host = 'localhost', $username = 'bjbsaprl_sanchari', $password = '@Sanchari0734', $db ='bjbsaprl_sanchari', $port = null, $charset = 'utf8', $socket = null)
	...
	public function getFieldName($table,$where,$whereValue,$field){

		$this->where($where,$whereValue);

		$rs = $this->getOne($table,$field);
